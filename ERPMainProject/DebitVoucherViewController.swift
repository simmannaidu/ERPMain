//
//  DebitVoucherViewController.swift
//  ERP
//
...
import UIKit
import Alamofire
class DebitVoucherViewController: UIViewController , UIPickerViewDelegate , UIPickerViewDataSource , UITextFieldDelegate {
    ...
    func getNotification()
        {
         self.showActivityIndicatory(view: self.view, isStart: true, transView: self.transView)
            let url : URL = URL(string:BaseUrl + "/debitvoucherNumber")!
...
//                                self.recentInvoiceBadgeCountLabel.text = "\(jsonRespone["invoice"] ?? "")"
     ...
     func save()
            {
             self.showActivityIndicatory(view: self.view, isStart: true, transView: self.transView)
                let url : URL = URL(string:BaseUrl + "/debitVoucher")!
